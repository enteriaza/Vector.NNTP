...
namespace Vector.NNTP.Encryption.Certificates
{
    ...
    /// synchronisation.  This is acceptable because the sole consumer
    /// (<see cref="System.Text.Json.JsonDocument.ParseAsync(Stream, System.Text.Json.JsonDocumentOptions?,
    /// CancellationToken)"/>) reads sequentially from a single async context.  In debug builds, a re-entrancy guard
    /// (<see cref="_activeRead"/>) detects accidental concurrent reads.</para>
    ///
    ...
    /// </list>
    /// </remarks>
    internal sealed partial class LengthLimitedReadStream : Stream
    {
        #region Constants
        ...
        /// negative.</exception>
        internal LengthLimitedReadStream(Stream inner, long maxBytes, string operation, ILogger? logger = null)
        {
        ...
        #region Stream Property Overrides
        ...
        #region CopyTo / CopyToAsync Overrides
        ...
        public override void CopyTo(Stream destination, int bufferSize)
        {
            ...
            byte[] rentedBuffer = ArrayPool<byte>.Shared.Rent(effectiveBufferSize);
            try
            {
                int bytesRead;
        ...
        #region Private Methods -- Limit Enforcement
        ...
        #region Private Methods -- Disposed-State Guard
        ...
        #region Private Methods -- Throw Helpers

        /// <summary>
        /// Throws <see cref="ArgumentException"/> when the inner stream does not support reading.  Isolated to keep
        /// the constructor IL below the JIT inlining threshold.
        /// </summary>
        [DoesNotReturn]
        ...
        #region Private Methods -- Debug Re-entrancy Guard
