...
namespace Vector.NNTP.Encryption.Cluster
{
    ...
    internal sealed partial class CertificateClusterSync
    {
        ...
        [LoggerMessage(EventId = 332, Level = LogLevel.Information,
        ...
        [LoggerMessage(EventId = 333, Level = LogLevel.Information,
        ...
        [LoggerMessage(EventId = 334, Level = LogLevel.Information,
        ...
        /// </summary>
        [LoggerMessage(EventId = 336, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 338, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 340, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 341, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 342, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 343, Level = LogLevel.Warning,
        ...
        /// </summary>
        [LoggerMessage(EventId = 344, Level = LogLevel.Warning,
        ...
        [LoggerMessage(EventId = 345, Level = LogLevel.Information,
        ...
        /// <summary>
        /// Logs that the leader connection shutdown cancellation source was already disposed.
        /// </summary>
        [LoggerMessage(EventId = 347, Level = LogLevel.Debug,
            Message = "Certificates: Leader connection shutdown CTS already disposed during ACME leader lock release")]
        private partial void LogLeaderConnectionCtsDisposed();
