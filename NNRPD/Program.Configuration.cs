...
{
    /// <summary>
    /// Host-specific JSON configuration loading for the NNRPD worker.
    /// </summary>
    public partial class Program
    {
        ...
        /// </summary>
        private const string HostConfigurationFileName = "NNRPD.json";
        ...
        private static void AddHostConfiguration(HostApplicationBuilder builder)
        {
            ...
            if (!File.Exists(path))
            {
                throw new FileNotFoundException(
                    ...
                    $"({builder.Environment.ContentRootPath}). Create or copy this file before starting NNRPD.",
                    path);
            }
