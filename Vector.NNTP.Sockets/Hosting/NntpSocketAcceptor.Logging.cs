...
namespace Vector.NNTP.Sockets.Hosting
{
    ...
    internal sealed partial class NntpSocketAcceptor
    {
        ...
        [LoggerMessage(
            EventId = 5,
            Level = LogLevel.Information,
            Message = "{ConnectionPrefix} Accepted transit peer (peer {PeerId}, name {PeerName}, matched {MatchedEntry})")]
        ...
        [LoggerMessage(
            EventId = 6,
            Level = LogLevel.Information,
            Message = "{ConnectionPrefix} Rejected transit peer: peer {PeerId} at capacity ({Occupied}/{MaxConnections}, 0=max unlimited)")]
        ...
        [LoggerMessage(
            ...
            Message = "{ConnectionPrefix} Rejected transit peer: Redis admission failed for peer {PeerId}")]
