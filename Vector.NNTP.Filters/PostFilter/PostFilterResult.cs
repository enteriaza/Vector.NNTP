...
namespace Vector.NNTP.Filters.PostFilter
{
    ...
    public readonly struct PostFilterResult
    {
        ...
        {
            this.ClientShouldSeeSuccess = clientShouldSeeSuccess;
            this.DropArticleAfterSuccessResponse = dropArticleAfterSuccessResponse;
            this.Code = code;
            this.ClientMessage = clientMessage;
            this.ModifiedArticleUtf8 = modifiedArticleUtf8;
        }

        /// <summary>
        /// When <see langword="false"/>, the host should emit an NNTP 4xx response using <see cref="ClientMessage"/> and <see cref="Code"/>.
        /// </summary>
        public bool ClientShouldSeeSuccess { get; }
        ...
        /// </summary>
        public bool DropArticleAfterSuccessResponse { get; }
        ...
        public ReadOnlyMemory<byte>? ModifiedArticleUtf8 { get; }

        /// <summary>Builds an unconditional accept (no body rewrite).</summary>
        /// <returns>Accept result.</returns>
        public static PostFilterResult Accept() => new(clientShouldSeeSuccess: true, dropArticleAfterSuccessResponse: false, code: 0, clientMessage: null, modifiedArticleUtf8: null);
        ...
        public static PostFilterResult AcceptWithBody(ReadOnlyMemory<byte> modifiedArticleUtf8) =>
            new(clientShouldSeeSuccess: true, dropArticleAfterSuccessResponse: false, code: 0, clientMessage: null, modifiedArticleUtf8: modifiedArticleUtf8);
        ...
        public static PostFilterResult Reject(int code, string clientMessage) =>
            new(clientShouldSeeSuccess: false, dropArticleAfterSuccessResponse: false, code: code, clientMessage: clientMessage, modifiedArticleUtf8: null);
    }
}
