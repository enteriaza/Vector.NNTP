...
namespace Vector.NNTP.Filters.PostFilter
{
        ...
        string? clientReverseDomain)
    {
        ...
        public IPAddress ClientIp { get; } = clientIp ?? throw new ArgumentNullException(nameof(clientIp));
        ...
        public string? AuthenticatedUsername { get; } = authenticatedUsername;
        ...
        public string? ClientReverseDomain { get; } = clientReverseDomain;
    }
}
